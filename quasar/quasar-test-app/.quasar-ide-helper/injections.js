...
Vue.prototype.$q = {
  ...
  bottomSheet : {
     ...
     * @param {{className : String|Array|Object, style : String|Array|Object, title : String, message : String, actions : Array, grid : Boolean, width : String, color : String, seamless : Boolean, persistent : Boolean}} opts Bottom Sheet options
  ...
  dialog : {
     ...
     * @param {{className : String|Array|Object, style : String|Array|Object, title : String, message : String, position : 'top'|'right'|'bottom'|'left'|'standard', options : {prompt : {model : Array|String, type : String}, options : {type : 'radio'|'checkbox'|'toggle', model : Array, items : Array}}, ok : String|{...props : *}|Boolean, cancel : String|{...props : *}|Boolean, width : String, stackButtons : Boolean, color : String, persistent : Boolean, no-esc-dismiss : Boolean, no-backdrop-dismiss : Boolean, no-route-dismiss : Boolean, seamless : Boolean, maximized : Boolean, full-width : Boolean, full-height : Boolean, transition-show : String, transition-hide : String}} opts Dialog options
     * @returns {{onOk : Function, onCancel : Function, onDismiss : Function, hide : Function}} Chainable Object
     */
    create (opts) {}
  },
